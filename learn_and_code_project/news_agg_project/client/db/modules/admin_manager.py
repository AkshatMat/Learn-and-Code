...
from client.utils.exception import DatabaseError, AuthenticationError
...
class AdminManager:
    ...
    def fetch_admin(self, username: str):
        try:
            ...
            raise DatabaseError(f"Failed to fetch admin: {str(e)}")
    ...
    def insert_admin(self, username: str, plain_password: str):
        try:
            ...
            raise DatabaseError(f"Failed to insert admin: {str(e)}")
