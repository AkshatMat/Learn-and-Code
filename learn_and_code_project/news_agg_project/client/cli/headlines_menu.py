...
from client.api_client.article_feedback_client import give_feedback
from client.utils.console_format import print_article_list
from client.utils.time_utils import current_time_info
from client.cli.notifications_menu import show_notifications_menu
    ...
    while True:
        ...
        if choice in ["1", "2"]:
            ...
            while True:
                ...
                print("4. Back to Headlines Menu")
                ...
                if sub_choice == "1":
                    ...
                    result = give_feedback(user_id, article_id, "like")
                    print(result.get("message", "No response"))
                elif sub_choice == "3":
                    article_id = input("Enter Article ID to dislike: ")
                    result = give_feedback(user_id, article_id, "dislike")
                    print(result.get("message", "No response"))
                elif sub_choice == "4":
                    break
                else:
