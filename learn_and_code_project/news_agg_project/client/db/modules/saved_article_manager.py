...
from client.utils.exception import DatabaseError, ArticleNotFoundError
...
class SavedArticleManager:
    ...
    def get_saved_articles(self, user_id: str):
        try:
            ...
            raise DatabaseError(f"Failed to fetch saved articles: {str(e)}")
    ...
    def save_article(self, user_id: str, article_id: str):
        try:
            ...
            raise DatabaseError(f"Failed to save article: {str(e)}")
    ...
    def delete_saved_article(self, user_id: str, article_id: str):
        try:
            ...
            raise DatabaseError(f"Failed to delete saved article: {str(e)}")
