...
from client.server.fast_api.routers import article_feedback
from client.server.fast_api.routers import notifications
from client.server.fast_api.routers import admin_apis
...
app.include_router(article_feedback.router, prefix="/articles", tags=["Feedback"])
app.include_router(notifications.router, prefix="/notifications", tags=["notifications"])
app.include_router(admin_apis.router, prefix="/admin/apis", tags=["Admin APIs"])
